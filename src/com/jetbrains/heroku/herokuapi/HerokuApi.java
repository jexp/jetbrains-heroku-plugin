...
import com.jetbrains.heroku.rest.RestException;
...
public class HerokuApi {
    ...
    public List<Application> allApps() {
        ...
        List data = (List) RestFormatHelper.parseJson(result);
    ...
    public static Credentials login(String email, String password) {
        try {
            final String result = createRestApi().post("/login", NO_OPTIONS, RestFormatHelper.format(RestFormatHelper.map("username", email, "password", password)));
    ...
    public Application create(String name, Map<String, String> params) {
        ...
        final Map<String, Object> info = (Map<String, Object>) RestFormatHelper.parseJson(this.restApi.post("/apps", NO_OPTIONS, RestFormatHelper.format(Collections.singletonMap("app", payload))));
    ...
    Map<String, Object> loadApplicationInfo(final String name) {
        ...
        return RestFormatHelper.parseXml(info);
    }
    ...
    Map<String, Object> listApplicationConfig(final String name) {
        ...
        return (Map<String, Object>) RestFormatHelper.parseJson(info);
    }
    ...
    List<Map<String, Object>> listApplicationAddons(final String name) {
        ...
        return (List<Map<String, Object>>) RestFormatHelper.parseJson(info);
    }
    ...
    List<Map<String, Object>> loadApplicationCollaborators(final String name) {
        try {
            ...
            return RestFormatHelper.parseNestedXml(info);
        } catch (Exception e) {
            e.printStackTrace();
